...
DIVERSE_SEED_TEXTS = [
    ...
    # ==================== SCIENCE AND KNOWLEDGE (60 sentences) ====================
    "the universe is approximately fourteen billion years old",
    "light travels at a speed of three hundred thousand kilometers per second",
    ...
    "evolution is the gradual change in species over many generations of time",
    "the earth orbits the sun once every three hundred sixty five days",
    "black holes are regions of space where gravity is so strong nothing escapes",
    "electricity flows through conductors when there is a potential difference",
    "quantum mechanics describes the behavior of particles at the atomic scale",
    "dna carries the genetic information that determines our biological traits",
    "the speed of sound in air is approximately three hundred forty meters per second",
    "computers process information using binary digits of zero and one",
    ...
    "volcanoes form when magma from below the earth surface reaches the surface",
    "tectonic plates move slowly across the mantle of the earth over time",
    "the moon causes tides in the oceans due to its gravitational pull",
    "stars are massive balls of gas that produce energy through nuclear fusion",
    "the milky way galaxy contains over two hundred billion stars",
    ...
    "artificial intelligence systems learn patterns from large amounts of data",
    "the ocean covers more than seventy percent of the earth surface",
    "climate change is causing global temperatures to rise steadily",
    "renewable energy sources include solar wind and hydroelectric power",
    "the human body is composed of trillions of cells working together",

    # ==================== STORYTELLING AND NARRATIVE (60 sentences) ====================
    "once upon a time in a land far away there lived a wise old king",
    "the adventurer set out on a journey through the dark enchanted forest",
    "she opened the ancient book and discovered a secret hidden inside",
    "the sun set slowly behind the mountains as the village grew quiet",
    "a young girl found a mysterious letter in her grandmother garden",
    "the detective examined the clues carefully before reaching a conclusion",
    "deep in the ocean a colorful world of sea creatures thrived peacefully",
    "the old lighthouse keeper told stories of ships lost in the fog",
    "the young scientist made a discovery that changed everything she knew",
    "thunder rumbled across the sky as the travelers sought shelter",
    "the market was filled with the sounds of vendors and happy customers",
    "the old map led them to a place no one had visited in centuries",
    "stars reflected off the calm lake as the travelers rested for the night",
    "the children played in the meadow as butterflies danced around them",
    "a gentle breeze carried the scent of flowers through the open window",
    "the mountain path was steep but the view from the top was breathtaking",
    "the musician played a melody that brought tears to the eyes of listeners",
    "the letter arrived on a rainy tuesday morning changing everything",
    "the old captain remembered every port he had visited in his long career",
    "the baker rose before dawn to prepare fresh bread for the village",

    # ==================== PHILOSOPHY AND IDEAS (40 sentences) ====================
    "knowledge is the foundation upon which wisdom is built over time",
    "every person has the capacity to learn and grow throughout their life",
    "the pursuit of happiness is a fundamental human desire worldwide",
    "great ideas often begin as small questions that no one has answered",
    "creativity is the ability to see the world in new and original ways",
    "courage is not the absence of fear but the willingness to act despite it",
    "patience is a virtue that allows us to achieve long term goals",
    "the meaning of life differs from person to person across cultures",
    "education opens doors that would otherwise remain forever closed",
    "freedom comes with the responsibility to respect others rights",
    "truth is often more complex than any simple statement can capture",
    "art reflects the soul of the culture that creates it",
    "progress requires the willingness to change and adapt over time",
    "empathy is the ability to understand and share the feelings of others",
    "every problem contains within it the seeds of its own solution",
    "history teaches us lessons that help us navigate the future wisely",
    "innovation drives civilization forward through new tools and ideas",
    "a curious mind is the greatest asset any person can possess",
    "cooperation allows people to achieve things no one could do alone",
    "the best investment you can make is in your own development",

    # ==================== NATURE AND ENVIRONMENT (40 sentences) ====================
    "the forest was alive with the sounds of birds and rustling leaves",
    "rain fell softly on the green fields as flowers opened their petals",
    "the river carved a winding path through the valley over centuries",
    "snow covered the mountains turning the landscape brilliant white",
    "autumn leaves fell in shades of red and gold across the path",
    "the tide came in slowly as gulls called overhead in the gray sky",
    "a rainbow appeared after the storm painting the sky with colors",
    "the desert stretched endlessly under a burning midday sun",
    "fireflies blinked in the warm summer night among the tall grass",
    "morning fog hung low over the fields as deer grazed quietly",
    "the coral reef was home to hundreds of species of fish and plants",
    "ancient trees stood in the old growth forest for hundreds of years",
    "migratory birds flew south in formation as winter approached",
    "the meadow was covered in wildflowers attracting bees and butterflies",
    "a single cloud drifted lazily across the clear blue summer sky",
    "the night sky in the countryside was filled with millions of stars",
    "spring brings new life as seeds sprout and animals emerge from hiding",
    "the smell of rain on dry earth is one of the most pleasant scents",
    "waves crashed rhythmically against the rocky shoreline below",
    "a hawk circled high above searching the ground for movement",

    # ==================== TECHNOLOGY AND PROGRESS (40 sentences) ====================
    "the internet has connected people across all corners of the world",
    "smartphones have changed the way we communicate and access information",
    "electric vehicles are becoming more common as battery technology improves",
    "machine learning enables computers to improve through experience",
    "renewable energy is transforming how we power our homes and cities",
    "medical technology has dramatically extended the average human lifespan",
    "satellites allow us to communicate and navigate with great precision",
    "three dimensional printing is revolutionizing manufacturing processes",
    "robotics is transforming industries from agriculture to healthcare",
    "the cloud allows people to store and access their data from anywhere",
    "video calls have made it possible to work from anywhere in the world",
    "online education has made learning accessible to millions of people",
    "digital payments are replacing cash in many parts of the world",
    "sensors embedded in devices collect data to make life more efficient",
    "virtual reality creates immersive experiences that feel very real",
    "cybersecurity protects individuals and organizations from digital threats",
    "gene editing technology may one day eliminate hereditary diseases",
    "space exploration continues to reveal new discoveries about our universe",
    "social media has fundamentally changed how information spreads",
    "algorithms make millions of decisions every second affecting our lives",
]
